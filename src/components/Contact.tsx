    ...
    return (
        ...
        <div className="flex flex-row items-center gap-10">
          <div className="flex flex-col">
            ...
            <input type="text" placeholder="John Doe |" className={`p-3 ${isDarkMode ? "text-[#646363]  bg-[#060503]" : "bg-[#EDE9DF] text-black"} border-[#858585] placeholder:text-xs border-b-[1px]`} />
          </div>
          <div className="flex flex-col">
            <p className="text-sm text-[#FFBA00] font-medium font-sans">Email:</p>
            <input type="text" placeholder="example@gmail.com" className={`p-3 placeholder:text-xs ${isDarkMode ? "text-[#646363]  bg-[#060503]" : "bg-white text-black"} placeholder:text-[#646363] border-b-[1px] border-[#858585]`} />
          </div>
        </div>
        <div className="flex flex-row items-center gap-10">
          <div className="flex flex-col">
            <p className="text-sm text-[#FFBA00] font-medium font-sans">Contact Phone:</p>
            <input type="text" placeholder="eg: 1123-419-345" className={`p-3 placeholder:text-xs ${isDarkMode ? "text-[#646363]  bg-[#060503]" : "bg-white text-black"} border-b-[1px] placeholder:text-[#646363] border-[#858585]`} />
          </div>
          <div className="flex flex-col">
            <p className="text-sm text-[#FFBA00] font-medium font-sans">City/Town:</p>
            <input type="text" placeholder="eg: California" className={`p-3 placeholder:text-xs ${isDarkMode ? "text-[#646363]  bg-[#060503]" : "bg-white text-black"} placeholder:text-[#646363] border-b-[1px] border-[#858585]`} />
          </div>
        </div>
        <div className="mx-auto flex flex-col gap-2">
          <p className="text-sm text-[#FFBA00] font-medium font-sans">Message:</p>
          <textarea placeholder="Write your message" className={`placeholder:text-xs placeholder:text-[#646363] ${isDarkMode ? "text-[#646363]  bg-[#060503]" : "bg-white text-black"}  p-2 border-b-[1px] border-[#858585]`}></textarea>
        </div>
