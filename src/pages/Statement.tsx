    ...
    return (
        <div className={`h-[100vh] flex flex-col w-full ${isDarkMode ? 'bg-[#0C0C0C] shadow-lg backdrop-blur-md' : 'bg-[#FFFDFB]'}`}> 
            ...
            <div className="w-full h-[90vh] flex items-center" style={{
                background: isDarkMode ? "url('/statement-bg.png')" : "url('/statement-bg-white.png')",
                backgroundSize: "cover",
                backgroundPosition: "center",
                backgroundRepeat: "no-repeat", 
            }}>
                <div className={`w-[80%] mx-auto ${isDarkMode ? "bg-[#21180D]" : "bg-[#F7F3E7]"} bg-[#21180D] flex flex-col justify-between h-[80vh]`}>
                    <div className="w-full flex flex-row justify-between items-center">
                        <div className="md:w-full">
                            <img src="/madoc.png" alt="owner" className=""  />
                        </div>
                        <div className={` p-10 text-sm flex flex-col gap-5 ${isDarkMode ? "text-white" : "text-black"}`}>
