    ...
    return (
        <div className={`h-[100vh] flex flex-col w-full ${isDarkMode ? 'bg-[#0C0C0C] shadow-lg backdrop-blur-md' : 'bg-[#FFFDFB]'}`}> 
            ...
            <div className="w-full h-[90vh] flex items-center" style={{
                ...
                <div className={`w-[80%] mx-auto ${isDarkMode ? "bg-[#21180D]" : "bg-[#F7F3E7]"} bg-[#21180D] flex flex-row justify-between h-[80vh]`}>
                    <img src="/madoc.png" alt="owner" className=""  />
                    <div className={`p-10 text-xs flex flex-col gap-5 ${isDarkMode ? "text-white" : "text-black"}`}>
